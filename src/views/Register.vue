...
const handleLogin = async () => {
    ...
    if (error) {
        ...
        toast.info('Данный адрес электронной почты уже зарегистрирован. Пожалуйста, войдите в систему или используйте другой адрес электронной почты.')

    } else {
        toast.success('Вы успешно зарегистрировались! Пожалуйста, подтвердите свою электронную почту, чтобы войти в систему.')
        router.push('/login')
    }
}
</script>
